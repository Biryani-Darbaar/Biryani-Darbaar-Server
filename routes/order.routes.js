...
router.get("/ordersByUser/:id", authenticateJWT, orderController.getOrdersByUser);
...
router.patch("/ordersAdmin/:id", authenticateJWT, orderController.updateOrderStatusAdmin);
router.get("/orders/total-count", authenticateJWT, orderController.getTotalOrderCount);

// Order status update endpoint (alternative route)
router.put("/order/status/:id", authenticateJWT, orderController.updateOrderStatusAdmin);
